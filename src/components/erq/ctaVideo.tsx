...
const CTA_VIDEO =
  "https://arqe-storage-images.nyc3.cdn.digitaloceanspaces.com/landing-page/migrated/Gd5sfX1JYNTJcsZSce7DsciNWI_optimized.mp4";

export function Cta() {
  return (
    <section id="video" className="px-5 sm:px-6 lg:px-10 pb-0">
      <div className="relative rounded-[14px] w-full aspect-[2.3/1] min-h-[400] overflow-hidden">
